...
import com.ead.course.models.services.ModuleSevice;
...
public class LessonController {
    ...
    public ResponseEntity<Object> saveLesson(@PathVariable(value = "moduleId") UUID moduleId,
        ...
        Optional<ModuleModel> moduleModelOptional = moduleSevice.findById(moduleId);
    ...
    public ResponseEntity<Object> deleteLesson(@PathVariable(value = "moduleId") UUID moduleId,
        ...
        Optional<LessonModel> lessonModelOptional = lessonService.findLessonsIntoModule(moduleId,lessonId);
